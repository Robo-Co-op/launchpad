...
```
/articles
├── claude-vs-chatgpt-jp.md         [Japanese, 800+ words]
├── best-ai-tools-japan-2026.md     [English, 800+ words]
├── gemini-vs-claude-jp.md          [Planned]
├── ai-productivity-tools-jp.md     [Planned]
...
2. Display ads (Google AdSense, custom partnerships)
3. Sponsored comparisons (ethical, clearly labeled)
4. Premium tools tier (SaaS integration, API)

**Expected timeline:**
- Month 1-2: Content foundation, organic traffic 100-500 visitors/day
...
- **Target Audience**: 
  - Japanese professionals exploring AI tools
  - Expats in Japan
  - Remote workers using Japanese services
  - Students learning AI in Japan

- **Primary Traffic Sources**:
  - Google Search (Japanese & English keywords)
  - YouTube embeds & backlinks
  - Reddit (r/Japan, r/AITools)
  - Twitter/X mentions
  - Japanese tech blogs
...
- [ ] Affiliate programs joined (minimum 3)
...
**Content manager**: CMO Launchpad
**Status**: Phase 1 - Article Foundation
